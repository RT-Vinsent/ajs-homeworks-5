# `РЕШЕНО Обе задачи в одном репозитории`,
## что бы не тратить ресурс appveyor.
## Комментарием пометил 2 метода и 4 теста от 2-ой задачи.

[![Build status](https://ci.appveyor.com/api/projects/status/yyd45gy07furdiev?svg=true)](https://ci.appveyor.com/project/RT-Vinsent/ajs-homeworks-5)
